---
title: "Buyer's Agent Commission in 2025: What You Paid"
slug: "buyers-agent-commission-2025"
pubDate: 2026-04-23
description: "Find out exactly what buyer's agent commissions looked like in 2025 after the NAR settlement. Average rates, who paid, and how to negotiate in 2026."
author: "Alex Morgan"
...
| Home Price | 2.5% Commission | 2.75% Commission | 3% Commission |
|------------|-----------------|-------------------|---------------|
...
For more strategies, see our [guide to negotiating real estate commissions](/how-to-negotiate-real-estate-commission).
...
| | Pre-2024 Model | 2025 Model |
|---|---|---|
| **Who set buyer-agent fee?** | Seller (via MLS offer) | Buyer (via representation agreement) |
| **Where was fee advertised?** | MLS listing | Not in MLS; negotiated in offer |
| **Total commission on $450K home** | ~$22,500–$27,000 (5–6%) | ~$22,500 (still common, but structure differs) |
| **Transparency for buyer** | Low—most buyers didn't know the split | High—buyers signed a fee agreement upfront |

Total transaction costs didn't drop dramatically in most markets. But transparency increased. Sellers in competitive markets used concessions strategically—offering to cover the buyer-agent fee to attract more offers. For more details, check our [listing agent commission breakdown](/listing-agent-commission-2025).
...
The key move: build the buyer-agent fee into your offer strategy from the start. Ask your lender what concession limits apply to your loan type, then write the concession request directly into your purchase offer. See our [first-time homebuyer cost guide](/first-time-homebuyer-costs) and [seller concessions guide](/seller-concessions-guide) for step-by-step walkthroughs.
...
It's a written contract between you and your buyer's agent that outlines the agent's duties, how long the agreement lasts, and what fee they will earn. After August 2024, this agreement became required before an agent could tour homes with a buyer. Learn more in our [buyer representation agreement guide](/buyer-representation-agreement-guide).
