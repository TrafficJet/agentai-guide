---
title: "Real Estate Broker Commission Splits Explained (2026)"
slug: "real-estate-broker-commission-split"
pubDate: 2026-04-23
description: "Learn how real estate broker commission splits work in 2026, including common models, negotiation tips, and what top agents actually keep after fees."
author: "Alex Morgan"
...
This split applies to both the listing side and the buyer side of any deal. Since the [NAR settlement](/nar-settlement-explained) took effect in August 2024, buyer-agent compensation is no longer embedded in MLS listings. But the split between you and your broker still applies to whatever commission you negotiate.
...
**Traditional independent brokerages:** A 50/50 to 60/40 split remains standard, especially for [new agents](/how-to-become-a-real-estate-agent) receiving mentorship, floor time, and leads.
...
**Pro tip:** Calculate your *effective split* by dividing your actual net earnings by your total gross commission for the year. This one number lets you compare [brokerages](/how-to-choose-a-real-estate-brokerage) on equal footing.
...
At $120,000 GCI, the cap model beats a traditional split by over $24,000. But if Sarah were producing only $40,000 GCI as a [new agent](/how-to-become-a-real-estate-agent), the training and leads at a traditional brokerage could help her close more deals. In that case, the lower split is worth the trade-off.
...
If you're a [new agent](/how-to-become-a-real-estate-agent) in your first two years, put mentorship, lead flow, and training quality ahead of split percentage. An agent closing 12 deals at 50/50 earns more than an agent closing 4 deals at 90/10. Experience compounds.
...
**Mid-level agent ($60K–$120K GCI):** Capped models start to outperform. Run the exact math at your production level using a commission split calculator before signing any [independent contractor agreement](/real-estate-independent-contractor-agreement).
...
In all 50 states, you can only receive commission through your sponsoring [broker](/real-estate-agent-vs-broker). Accepting a direct payment from a client without broker involvement is illegal and can result in license revocation.
...
The NAR rule change removed cooperative compensation from MLS listings, so buyer-agent fees are now negotiated separately through a [buyer agency agreement](/buyer-agency-agreement-guide). This created more variation in total commission amounts, pushing some brokerages to adjust their fee structures.
...
*This article was written by a licensed real estate broker with over a decade of experience across independent and franchise brokerages. For state-specific split guidance, check our [agent income by state](/real-estate-agent-income-by-state) resource.*