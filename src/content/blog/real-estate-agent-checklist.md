...
## What Is a Real Estate Agent Checklist?
...
**6. Set up a lockbox and confirm showing instructions.** Coordinate with the seller on pet arrangements, alarm codes, and preferred showing windows.

**7. Create a marketing plan.** This should include social media promotion, email blasts to your database, a broker open house, and at least one public open house in the first two weeks.

**Real-world example:** Agent Maria Torres in Austin, TX, credits her pre-listing checklist with helping her avoid a $14,000 pricing error. Her CMA process flagged that a comp the seller found on Zillow had been updated with a $40,000 renovation — something not visible in the listing photos. Without a systematic CMA step, that inflated comp could have led to an overpriced listing and weeks of wasted market time.
...
**5. Attend the closing.** Review each page with your client as they sign. Verify the purchase price, loan terms, closing costs, and proration amounts match what was agreed upon.
...
**1. Send a handwritten thank-you note within 48 hours.** A physical card stands out more than an email. Include a small closing gift if it fits your budget — popular choices include a gift card to a local restaurant or a home-maintenance toolkit.

**2. Request a Google or Zillow review.** Send a direct link to make it easy. Agents with 25 or more Zillow reviews receive approximately 40% more contact requests than agents with fewer than 10 (Zillow Agent Resources, 2025). Time this request within the first week after closing, when client satisfaction is highest.

**3. Add the client to your CRM drip campaign.** Set up automated emails for home anniversaries, local market updates, and holiday check-ins. This keeps you top-of-mind for referrals. See our recommendations for the [best CRM for real estate agents](/best-crm-for-real-estate-agents).

**4. Update your transaction log and commission tracker.** Record the sale price, your gross commission, brokerage split, and any referral fees paid.
...
**E-signature:** DocuSign and Authentisign let you send contracts for signature from your phone in minutes. Both comply with the federal Electronic Signatures in Global and National Commerce Act (E-SIGN Act), which gives electronic signatures the same legal standing as handwritten ones.
...
### What should a real estate agent checklist include?
A complete checklist covers pre-listing tasks, buyer representation steps, offer and negotiation actions, under-contract deadlines, closing day tasks, and post-closing follow-up. Breaking it into phases keeps you from missing critical steps.

### Do new real estate agents need a different checklist than experienced agents?
...
### How often should a real estate agent update their checklist?
Review your checklist at least once a year or whenever state laws, NAR guidelines, or brokerage policies change. Many agents update after a problematic transaction to prevent the same issue from recurring. The 2024 NAR settlement, for example, required every buyer's agent to revise their pre-showing checklist to include the new representation agreement step.

### What is the most commonly missed step on a real estate agent checklist?
Post-closing follow-up is the most frequently skipped phase. Agents who send thank-you notes, request reviews, and schedule 30-day check-in calls tend to generate significantly more referrals over time. The under-contract phase is a close second — contingency deadlines are easy to lose track of when you're juggling multiple active deals.

---

*Download our free printable real estate agent checklist (PDF) below. Enter your email address and we'll send it to your inbox — formatted for letter-size paper and ready to customize with your branding.*